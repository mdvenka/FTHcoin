...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " faithcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  faithcoin-tx [options] <hex-tx> [commands]  Update hex-encoded faithcoin transaction\n" +
            "or:     faithcoin-tx [options] -create [commands]   Create hex-encoded faithcoin transaction\n" +
            "\n";
