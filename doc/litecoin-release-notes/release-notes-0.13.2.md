Faithcoin Core version 0.13.2 is now available from:
  ...
  <https://download.faithcoin.org/faithcoin-0.13.2.1/>
...
Then, to tunnel a SSL connection on 29333 to a RPC server bound on localhost on port 19334 do:

    stunnel -d 29333 -r 127.0.0.1:19334 -p stunnel.pem -P ''
