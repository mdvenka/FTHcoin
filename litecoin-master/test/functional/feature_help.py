...
"""Verify that starting faithcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start faithcoin with -h for help text")
        ...
        self.log.info("Start faithcoin with -version for version information")
        ...
        self.log.info("Start faithcoind with -fakearg to make sure it does not start")
