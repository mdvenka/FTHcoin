Faithcoin Core version *0.15.1* is now available from:
  ...
  <https://download.faithcoin.org/faithcoin-0.15.1/>
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 blessings per kB (0.00001 FTH). This is to prepare for dropping the minimum transaction fee to 0.1 blessings per kB (0.0001 FTH) in the next release.
